...
const styles = {
  style20_1: "flex h-10 w-full items-center justify-between rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
  style27_2: "h-4 w-4 opacity-50",
  style40_3: "flex cursor-default items-center justify-center py-1",
  style45_4: "h-4 w-4",
  style57_5: "flex cursor-default items-center justify-center py-1",
  style62_6: "h-4 w-4",
...
>(({ className, children, ...props }, ref) => (
  ...
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className={styles.style27_2} />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ...
    {...props}
  >
    <ChevronUp className={styles.style45_4} />
  </SelectPrimitive.ScrollUpButton>
))
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollDownButton
    ...
    {...props}
  >
    <ChevronDown className={styles.style62_6} />
  </SelectPrimitive.ScrollDownButton>
))
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(styles.style106_11, className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    {...props}
  >
    <span className={styles.style124_13}>
      <SelectPrimitive.ItemIndicator>
        <Check className={styles.style126_14} />
      </SelectPrimitive.ItemIndicator>
    </span>
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn(styles.style141_15, className)}
    {...props}
  />
))
