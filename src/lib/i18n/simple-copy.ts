...
export const simpleCopy = {
 ...
 drivers: { ar: 'السائقون', en: 'Captains' },
 ...
 searchingDrivers: { ar: 'نبحث عن سائق قريب.', en: 'Looking for a nearby driver.' },
 driverOnWay: { ar: 'السائق في الطريق إليك.', en: 'Your driver is on the way.' },
 confirmArrival: { ar: 'تأكيد الوصول', en: 'Confirm arrival' },
 rateTrip: { ar: 'قيّم الرحلة', en: 'Rate trip' },
 noDrivers: { ar: 'لا يوجد سائقين قريبون حالياً.', en: 'No nearby captains right now.' },
 },
