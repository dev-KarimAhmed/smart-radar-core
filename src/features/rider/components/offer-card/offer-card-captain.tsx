...
import { Car, Building2, Trophy, ExternalLink, Facebook, Instagram } from 'lucide-react';
...
export function OfferCardCaptain({
  ...
  const hasContactLinks = Boolean(captain.contact_url || captain.facebook_url || captain.instagram_url);
