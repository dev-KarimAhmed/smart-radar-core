...
const styles = {
  ...
  independentButton:
    'w-full h-14 text-base border border-[#243249] hover:border-[#10B981]/60 bg-[#0B0F19] hover:bg-[#161F30] text-white rounded-xl transition-all duration-300 font-bold shadow-[0_4px_15px_rgba(0,0,0,0.3)] hover:shadow-[0_4px_20px_rgba(16,185,129,0.15)] flex items-center justify-center gap-2 cursor-pointer active:scale-[0.98]',
...
export function CaptainAffiliationStep({
  ...
  return (
    <div className={styles.root} dir={isArabic ? 'rtl' : 'ltr'}>
      ...
      <button type="button" className={styles.independentButton} onClick={() => onSelect('independent')}>
        <span>🚗</span>
