...
const styles = {
  style72_1: "space-y-4 text-right animate-fade-in",
  style74_2: "rounded-xl border border-[#14B8A6]/25 bg-[#14B8A6]/10 p-3 text-right",
  ...
  style91_5: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style98_6: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style103_7: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style111_8: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style115_9: "grid grid-cols-2 gap-2",
  style117_10: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style124_11: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style129_12: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style136_13: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style142_14: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style150_15: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style160_16: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style167_17: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style171_18: "grid grid-cols-2 gap-2",
  style173_19: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style180_20: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style185_21: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style192_22: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style197_23: "grid grid-cols-2 gap-2",
  style199_24: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style206_25: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style211_26: "block text-[10px] font-medium text-[#94A3B8] tracking-wider uppercase mb-1 text-right",
  style219_27: "w-full bg-[#0B0F19] border border-[#243249] focus:border-[#14B8A6] text-[#F8FAFC] placeholder-[#94A3B8]/30 rounded-xl px-4 h-11 text-sm outline-none transition-all duration-300 text-right",
  style230_28: "p-3 rounded-xl bg-[#0B0F19] border border-[#14B8A6]/20 text-right space-y-2",
