  ...
  return (
    <div className="w-full overflow-hidden py-3 bg-zinc-950/60 rounded-2xl border border-white/5 relative" dir="ltr">
      <div className="absolute top-2.5 right-3.5 z-10 flex items-center gap-1.5 select-none pointer-events-none" dir="rtl">
        ...
        <span className="text-[8px] font-black text-emerald-400 uppercase tracking-widest font-mono">LIVE AD STREAM PREVIEW • الإعلانات الحي</span>
      </div>
  ...
  return (
    <div className="w-full flex flex-col pb-20 max-w-2xl mx-auto p-4 sm:p-6 relative select-none font-sans text-right animate-fade-in" dir="rtl">
      ...
      <div className="bg-[#050c05] border border-emerald-950/40 p-2 rounded-xl mb-3.5 flex items-start gap-2 relative overflow-hidden">
        ...
        <div className="space-y-0.5">
          <h4 className="text-[11px] font-black text-emerald-300">ميثاق حوكمة الإعلانات (شروط الرادار الدائري):</h4>
                        ...
                        >
                          <div className="p-3 space-y-2 text-xs text-gray-300">
                            ...
                            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 text-[9px] font-mono text-gray-400">
                              ...
                              <div className="bg-zinc-900/40 p-1.5 rounded-lg border border-white/5">
                                النشاط المستهدف: <span className="text-white">{(ad.targetImpressions || 0).toLocaleString()}</span>
                              </div>
                              <div className="bg-zinc-900/40 p-1.5 rounded-lg border border-white/5">
                                النشاط الفعلي: <span className="text-emerald-400">{(ad.currentImpressions || 0).toLocaleString()}</span>
                              </div>
                              <div className="bg-zinc-900/40 p-1.5 rounded-lg border border-white/5">
                              ...
                              <div className="bg-rose-950/20 border border-rose-500/20 p-2.5 rounded-xl mt-1 animate-fade-in text-right">
                                <div className="flex items-start gap-1 py-0.5 text-center shrink-0">
                                  ...
                                  <div className="text-right">
                                    <span className="text-[9px] font-black text-rose-400 block">إفادة مركز السلامة  (سبب الرفض):</span>
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 bg-gradient-to-br from-emerald-950/20 to-neutral-900/60 border border-emerald-500/30 rounded-2xl space-y-3 relative overflow-hidden">
              ...
              <p className="text-[11px] text-gray-100 leading-relaxed font-sans font-medium">
                🏆 تهانينا! إعلانك غطى <strong className="text-emerald-300">94%</strong> من السعة الإعلانية المتاحة في منطقة ناعور خلال آخر 24 ساعة وجلب لك <strong className="text-emerald-300">45</strong> اتصالاً مباشراً. الميدان متعطش لنشاطك، هل تريد تكرار النشاط للأسبوع القادم بخصم رتبة المعلن الوفي؟
              </p>
                    ...
                    {openSecs[1] && (
                      ...
                      >
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                          ...
                          <div className="space-y-1">
                            <Label className="text-[10px] text-emerald-400 font-bold block">المنطقة المستهدف</Label>
                        ...
                        <div className="space-y-1 pt-1">
                          <Label className="font-bold text-[10px] text-emerald-400 block">مرات الظهور والنشاط المطلوبة لحجم الاكتساح:</Label>
                          <Select onValueChange={(val) => setTargetImpressions(parseInt(val))} value={targetImpressions.toString()}>
                            ...
                            <SelectContent className="bg-black text-white border-white/10">
                              ...
                              <SelectItem value="10000" className="text-right justify-end text-xs">10,000 ظهور (انتشار واسع في المنطقة)</SelectItem>
                              <SelectItem value="50000" className="text-right justify-end text-xs">50,000 ظهور (تأثير  وشامل)</SelectItem>
                            </SelectContent>
                          </Select>
                        </div>
                            ...
                            {isCapacityFull ? (
                              <div className="p-2.5 bg-amber-950/20 border-2 border-dashed border-amber-500/40 rounded-xl space-y-2">
                                ...
                                <p className="text-[10px] text-gray-300 leading-normal font-medium">
                                  “الوقت الحالي ممتلئ، ولكن يوجد زخم ركاب مرتفع في المنطقة المجاور <strong className="text-amber-400">ناعور</strong> نتيجة تذبذب الأسعار بنسبة 10%، نقترح توجيه حملتك هناك لتحقيق مشاهدات أعلى بجودة أكبر”.
                                </p>
                                <Button
                                  type="button"
                ...
                <div className="border border-white/10 rounded-xl bg-neutral-900/40 overflow-hidden transition-all duration-300">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] font-black">القسم (2): مادة الإعلانات والاتصالات المباشرة (مادي)</span>
                    </div>
                    <div className="flex items-center gap-2 text-[9px] text-gray-500 font-mono">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 items-start">
                          <div className="space-y-2">
                            ...
                            <div className="p-2 bg-white/5 rounded-lg border border-white/10 space-y-1.5">
                              <span className="text-[9px] font-black text-gray-400 block border-b border-white/5 pb-0.5">روابط التواصل المباشرة (Direct Acquisition Links)</span>
                              <div className="grid grid-cols-2 gap-1.5">
                                <div className="space-y-1">
                                  <Label className="text-[9px] text-gray-400">رقم الواتساب </Label>
                                  <Input
                                    value={whatsapp}
                ...
                <div className="border border-white/10 rounded-xl bg-neutral-900/40 overflow-hidden transition-all duration-300">
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[11px] font-black">القسم (3): التسعير والذكاء الاصطناعي  (تسعيري)</span>
                    </div>
                    ...
                    {openSecs[3] && (
                      ...
                      >
                        ...
                        <div className="pt-2 grid grid-cols-2 gap-2">
                          ...
                          <div className="bg-neutral-900/90 p-2.5 rounded-xl border border-white/5 flex flex-col justify-center items-center text-center">
                            <span className="text-[8px] text-gray-500 font-bold">رصيد محفظتك  الجاري:</span>
                ...
                {!isSimulatingAudit && auditApproved && (
                  <div className="p-3.5 bg-emerald-950/20 border border-emerald-500/20 rounded-xl space-y-2">
                    ...
                    <p className="text-[10px] text-gray-300 leading-relaxed">
                      تم إضافة إعلانك بنجاح في قائمة النشاط الميداني بمحافظة <strong className="text-emerald-400">{governorate}</strong> - منطقة <strong className="text-emerald-400">{district}</strong>.
                    </p>
                  </div>
                )}
              </div>
