...
const safeFinalHook = finalHook.replace(/const renderDetailedReview = \([\s\S]*?;\n  };\n\n/g, '');

fs.writeFileSync('src/features/account/components/history-tab/use-history-state.ts', safeFinalHook);
