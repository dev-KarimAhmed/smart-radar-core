...
const returnIndex = hookBody.indexOf('return {', reviewIndex);
if (reviewIndex > -1 && returnIndex > -1) {
  hookBody = hookBody.substring(0, reviewIndex) + hookBody.substring(returnIndex);
}
...
console.log('Hook rewritten cleanly, renderDetailedReview fully removed.');
